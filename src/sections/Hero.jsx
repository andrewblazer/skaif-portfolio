...
const Hero = () => {
    return (
        <section className='flex flex-col-reverse lg:flex-row justify-between items-center lg:items-start min-h-screen p-5 lg:p-10'>
            <div id='left' className='w-full lg:w-1/2 flex flex-col gap-5 text-center lg:text-left'>
                ...
                <div id='center' className='flex flex-col lg:flex-row gap-5 mt-10'>
                    ...
                    <OutlineButton href="/src/assets/CV Muhammad Azfa.pdf" download="Azfa.pdf">
                        Download CV
                    </OutlineButton>
                </div>
                <div id="bottom" className='mt-5'>
                    <div className='bg-white bg-opacity-5 grid grid-cols-3 w-fit mx-auto lg:mx-0 p-4 rounded-md'>
                        <div className='border-r-2 px-4 flex flex-col items-center justify-center border-[#959595]'>
                            <p className='text-[#0080FF] text-xl lg:text-2xl font-bold tracking-wide'>5+</p>
                            <p className='text-sm lg:text-base'>Experiences</p>
                        </div>
                        <div className='border-r-2 px-4 flex flex-col items-center justify-center border-[#959595]'>
                            <p className='text-[#0080FF] text-xl lg:text-2xl font-bold tracking-wide'>16+</p>
                            <p className='text-sm lg:text-base'>Projects</p>
                        </div>
                        <div className='px-4 flex flex-col items-center justify-center'>
                            <p className='text-[#0080FF] text-xl lg:text-2xl font-bold tracking-wide'>20+</p>
                            <p className='text-sm lg:text-base'>Clients</p>
                        </div>
                    </div>
                </div>
            </div>
            <div id='right' className='w-full lg:w-1/2 flex justify-center lg:justify-end mt-10 lg:mt-0'>
                <div className='bg-white bg-opacity-5 rounded-full flex justify-center items-center max-w-[90%] max-h-[90%] lg:max-w-[719px] lg:max-h-[719px]'>
                    <img src={ProfilePhoto} alt="Foto Portrait Muhammad Azfa" className='w-3/4 lg:w-full duration-700 transition-all ease-in-out' />
                </div>
            </div>
        </section>
